...
public class ClientePjController {
    ...
    @Autowired
    public ClientePjController(ClientePjServiceImpl clientePjService) {
    ...
    private ClientePjResponseDTO createResponseDTO(ClientePj clientePj) {
        ...
        responseDTO.setEmail(clientePj.getEmailContatoEstabelecimento());
        return responseDTO;
    }
    ...
    public ResponseEntity<ClientePjResponseDTO> atualizarClientePj(@Valid @RequestBody ClientePjRequestDTO clientePjRequestDTO) {
        try {
            ...
            clienteExistente.setEmailContatoEstabelecimento(clientePjRequestDTO.getEmail());
